...
/**
 * repeated_char - count repetitions of a character
 *
 * @input: input string
 * @i: index
 * Return: repetitions
...
/**
 * first_char - find index of the first character
 *
 * @input: input string
 * @i: index
...
/**
 * print_syntax_error - print when  syntax error is found
 *
