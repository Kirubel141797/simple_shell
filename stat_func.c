...
/**
 *stat_fun - evaluates an initial condition of argument
 *@_str: a pointer of pointer to evaluate
 *@_fl: a flag to control pointer free
 *@_com: a command in a shell
 *@env: an environ variable
 *@c: To count the cicles
 *@av_0: To first main argument
 *
