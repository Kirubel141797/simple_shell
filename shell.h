...
/**
 * struct tpesPer - A structure for a percentage formats
 * @t: To format for a percentage
 * @f: A function
 */
...
/**
 *struct bu_in - A structure to a reference in the right built in function
 *@s: An string to be evaluates
 *@fun: A function correspont to be a string
 */
